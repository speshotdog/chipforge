...
- **Piano-roll 編輯**：4 音軌（方波主旋律、方波和聲、三角波貝斯、噪音）+ 3 鼓道、長音、滑音、重音、連打（32分）、和弦引導光
- **剪輯式時間軸**：段落色帶點/拖 scrub、Ctrl+滾輪縮放、框選多選（拖移/複製/貼上/刪除）、A-B 區間循環、軌道獨顯，快捷鍵全部可自訂（⌨ 按鈕）
- **雷特動機**：記住旋律動機，之後每首新曲的主歌/副歌都以它開場（Undertale 式）
- **日夜配對**：一鍵衍生夜間變奏（旋律抽疏連音化＋鼓退心跳＋鋼琴主奏＋回音加深）
